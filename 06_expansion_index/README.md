...
| 对象 | 首次发现 | 来源 | 分类 | 项目关系 | 状态 | 优先级 | 已深入 | 已验证 |
|---|---|---|---|---|---|---|---|---|
| DeepSeek Harness v0.1 | 2026-09-02 | DeepSeek 开源 | Harness/Runtime（S5） | TeamMind（同构对照） | [cand] | **S** | 否 | 未 |
...
| MS Research Webwright | 2026-09-02 | MS Research | Computer Use / Web Agent | E2E-CLI/campus_order | [cand] | B | 否 | 未 |
| hermes-agent（Nous Research） | 2026-09-02 | GitHub/ClawBench | Agent Framework | OpenClaw 对照 | [cand] | B | 否 | 未 |
