...
| inbox/ | 原始线索（未筛选） | ⬜ |
| candidates/ | 候选证据卡（待深入） | 📌 31 张（首轮 4 + Expansion 13 + 雷达 5 + 09-03 雷达 2 + 09-04 雷达 1 + 09-05 雷达 2 + 09-06 雷达 1 + 09-07 雷达 1 + 09-08 雷达 2；DeepSeek Harness 已晋升） |
| validated/ | 已验证高价值对象（可入内库） | 📌 2 张（DeepSeek Harness S + promptfoo S） |

### candidates/（截至 2026-09-08 雷达第 7 次，共 31 张）
...
| 目录 | 内容 | 状态 |
|---|---|---|
| [README.md](04_connections/README.md) | 外部技术 ↔ 现有项目/知识连接说明 | 📌 31 行全升 🟡 |
...
| 目录 | 内容 | 状态 |
|---|---|---|
| [README.md](06_expansion_index/README.md) | Expansion Index：全对象清单 + 生命周期 + 去重基准 | 📌 31 条 |
